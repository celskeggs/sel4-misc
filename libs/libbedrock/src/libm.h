#ifndef LIB_BEDROCK_LIBM_H
#define LIB_BEDROCK_LIBM_H

/* derived from: musl src/internal/libm.h */
...
// this snippet from musl arch/x32/bits/alltypes.h.in
